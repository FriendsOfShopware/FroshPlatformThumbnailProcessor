...
namespace Frosh\ThumbnailProcessor\Storefront\Framework\Twig;
...
/**
 * the only change is the filename thumb_proc_thumbnail.html.twig
 */
final class ThumbProcThumbnailTokenParser extends AbstractTokenParser
{
    /**
     * @var Parser
     */
    ...
    public function parse(Token $token): SwInclude
    {
        ...
        $expr->setAttribute('value', '@Storefront/storefront/utilities/thumb_proc_thumbnail.html.twig');
